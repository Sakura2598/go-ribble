...
import (
	...
	"github.com/Sakura2598/go-ribble/crypto/signify"
	"github.com/Sakura2598/go-ribble/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/Sakura2598/go-ribble/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/Sakura2598/go-ribble/internal/version.gitDate="+env.Date)
	}
